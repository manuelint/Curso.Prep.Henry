...
function operadoresLogicos(num1, num2, num3) {
  ...
  else if (Math.sign(num1) === -1 || Math.sign(num2) === -1 || Math.sign(num3) === -1 ) { return 'Hay negativos'}

  else if (num1 > num2 && num1 > num3 && Math.sign(num1) === 1) { return 'Número 1 es mayor y positivo' }
